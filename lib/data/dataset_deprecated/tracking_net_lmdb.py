...
import json
from ...utils.lmdb_utils import decode_img, decode_str
...
class TrackingNet_lmdb(BaseImageSequenceDataset):
    """ TrackingNet dataset.
    ...
    def _load_class_info(self):
        ...
        class_map_path = os.path.join(ltr_path, 'assets', 'trackingnet_classmap.txt')
