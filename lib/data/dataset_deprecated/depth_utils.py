...
def get_x_frame(color_path, depth_path, dtype='rgbcolormap', depth_clip=False): # SHITCODE: this function is useful, but should not be in 'depth_utils.py', because it can be used for other tasks.
