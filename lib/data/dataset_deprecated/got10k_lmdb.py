...
from ..utils import jpeg4py_loader
...
class Got10k_lmdb(BaseImageSequenceDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, seq_ids=None, data_fraction=None):
        ...
        if split is not None:
            ...
            if split == 'train':
                file_path = os.path.join(train_lib_path, 'assets', 'got10k_train_split.txt')
            elif split == 'val':
                file_path = os.path.join(train_lib_path, 'assets', 'got10k_val_split.txt')
            elif split == 'train_full':
                file_path = os.path.join(train_lib_path, 'assets', 'got10k_train_full_split.txt')
            elif split == 'vottrain':
                file_path = os.path.join(train_lib_path, 'assets', 'got10k_vot_train_split.txt')
            elif split == 'votval':
                file_path = os.path.join(train_lib_path, 'assets', 'got10k_vot_val_split.txt')
            else:
