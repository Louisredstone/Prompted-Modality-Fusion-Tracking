...
class VOT_RGBD2022(BaseImageSequenceDataset):
    """ VOT-RGBD2022 dataset.
    """
    ...
    def __init__(self, root=None, dtype='rgbcolormap', split='train', image_loader=jpeg4py_loader_w_failsafe): #  vid_ids=None, split=None, data_fraction=None
        ...
        """
        root = env_settings().vot_rgbd2022_dir if root is None else root
        super().__init__('VOT_RGBD2022', root, image_loader)
    ...
    def _build_sequence_list(self):
        ...
        # file_path = os.path.join(ltr_path, 'assets', 'depthtrack_%s.txt'%self.split)
