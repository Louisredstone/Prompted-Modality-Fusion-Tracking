...
class OSTrackWithPrompt(nn.Module):
    ...
    def build(cfg, training=True):
        ...
        if cfg.MODEL.BACKBONE.TYPE == 'vit_base_patch16_224_prompt':
            backbone = VisionTransformerWithPrompt.build_base(pretrained, drop_path_rate=cfg.TRAIN.DROP_PATH_RATE,
            ...
            backbone = VisionTransformerCEWithPrompt.build_base(pretrained, drop_path_rate=cfg.TRAIN.DROP_PATH_RATE,
