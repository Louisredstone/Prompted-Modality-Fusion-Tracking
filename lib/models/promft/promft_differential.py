...
class PromptBlockDifferential(nn.Module,):
    def __init__(self, inplanes=None, hide_channel=None, smooth=False):
        super(PromptBlockDifferential, self).__init__()
        ...
        raise NotImplementedError() # this class is not finished yet
...
class ProMFTDifferential(BaseProMFT):
