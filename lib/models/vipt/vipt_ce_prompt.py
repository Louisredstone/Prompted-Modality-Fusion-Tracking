...
'''The Implementation of ViPT.
This file is basically copied from the official ViPT implementation, with minimal modifications in order to fit relevant python modules.'''
