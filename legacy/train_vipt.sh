echo "WE DO NOT NEED THIS SCRIPT ANYMORE"
echo "See <root>/train.py instead."
exit 1

# Training ViPT
python tracking/train.py --script vipt --config deep_rgbd --save_dir ./output --mode multiple --nproc_per_node 3
nohup python tracking/train.py --script vipt --config deep_rgbt --save_dir ./output --mode multiple --nproc_per_node 2 >log.txt 2>&1 &
